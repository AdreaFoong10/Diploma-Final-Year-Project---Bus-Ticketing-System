                                                    ...
                                                    <div class="customer">
                                                        ...
                                                        <form method="POST">
                                                            ...
                                                            <div style="margin-top: 5rem; flex-direction: row; display: flex; align-items: normal;">
                                                                ...
                                                                <select style="flex-direction: row;" id="bus_s_route" placeholder="Bus Route" name="bus_s_route" required >
                                                                    <?php
                                                                        ...
                                                                        {
                                                                            $route_id_get_data = $row_route_sql['route_id'];

                                                                            
                                                                            

                                                                        ?>
                                                                        <option value="<?php echo $route_id_get_data ?>"><?php echo $route_id_get_data ?> - <?php echo $row_route_sql['starting_point'] ?> to <?php echo $row_route_sql['destination'] ?></option>
                                                            ...
                                                            <div style="margin-top: 5rem; flex-direction: row; display: flex; align-items: normal;">
                                                                ...
                                                                <input type="date" id="bus_s_date" style="flex-direction: row;" placehoder="Date" name="bus_s_date" size="10" required>
                                                            </div>
                                                            ...
                                                            <div style="margin-top: 5rem; flex-direction: row; display: flex; align-items: normal;">
                                                                ...
                                                                <input type="time" style="flex-direction: row;" id="bus_s_depart" placeholder="Departure Time" name="bus_s_depart" size="35" required>
                                                            </div>

                                                            <!-- Bus Schedule Arrival Time with inline css -->
                                                            <div style="margin-top: 5rem; flex-direction: row; display: flex; align-items: normal;">
                                                                <label for="bus_s_arrival"><h4 style="font-size: 1.5em">Arrival Time : </h4> </label>
                                                                <input type="time" style="flex-direction: row;" id="bus_s_arrival" placeholder="Arrival Time" name="bus_s_arrival" size="35" required>
                                                            </div>

                                                            <!-- Bus Schedule Fare with inline css -->
                                                            <div style="margin-top: 5rem; flex-direction: row; display: flex; align-items: normal;">
                                                                <label for="bus_s_fare"><h4 style="font-size: 1.5em">Fare : </h4> </label>
                                                                <input type="number" style="flex-direction: row;" id="bus_s_fare" min="1" placeholder="RM " name="bus_s_fare" size="5" required>
                                                            </div>

                                                            <!-- Bus Schedule Gate with inline css -->
                                                            <div style="margin-top: 5rem; flex-direction: row; display: flex; align-items: normal;">
                                                                <label for="bus_s_gate"><h4 style="font-size: 1.5em">Gate : </h4> </label>
                                                                <input type="text" style="flex-direction: row;" id="bus_s_gate" placeholder="Gate" name="bus_s_gate" size="10" maxlength="1" required>
                                                            </div>

                                                            <!-- Bus Operator ID with inline css -->
                                                            <div style="margin-top: 5rem; flex-direction: row; display: flex; align-items: normal;">
                                                                <label for="bus_s_operator"><h4 style="font-size: 1.5em">Bus Operator : </h4> </label>
                                                                <select style="flex-direction: row;" id="bus_s_operator" placeholder="Bus Operator" name="bus_s_operator" required>
                                                                    <?php
...
<?php 
    if(isset($_POST['saveprofile']))
    {
        ...
        $admin_id_for_schedule = $admin_profile_id;
        ...
        while($run_check_bus_schedule_date = mysqli_fetch_assoc($check_bus_schedule_date))
        {
            ...
            if($bus_route_id === $check_route_id)
            {
                ...
                <script>
                       Swal.fire({
                          title: 'Error!',
                          html: 'The Route based on Bus Schedule Date that you selected is existed.<br>Please enter a Different Route.',
                          icon: 'error',
                          showConfirmButton: true,
                          timer: 5000
                      });
        ...
        $get_sql_bus_schedule_time = mysqli_query($conn, "SELECT departure_time, arrival_time FROM bus_schedule WhERE route_id = $bus_route_id");
        ...
        <script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '/FYP/admin/bus schedule/add bus schedule process.php',
                        type: 'POST',
                        data: {
                            ...
                            admin_id : '<?php echo $admin_id_for_schedule ?>',
                            bus_status : '<?php echo $bus_schedule_status ?>',
