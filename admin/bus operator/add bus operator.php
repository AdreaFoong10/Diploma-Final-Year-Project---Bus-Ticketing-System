                                                    ...
                                                    <div class="customer">
                                                        ...
                                                        <form method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div style="font-size: 12px; margin-top: 5rem; flex-direction: row; display: flex; align-items: normal;">
                                                                <img src="pictures/default picture.png" id="pic_now" style="max-width: 300px; max-height: 200px;" alt="">
                                                            ...
                                                            <div style="margin-top: 5rem; flex-direction: row; display: flex; align-items: normal;">
                                                                ...
                                                                <input type="text" style="flex-direction: row; margin-left: 2.55rem;" id="operator_name" placeholder="Name" name="operator_name" size="35" required>
                                                            </div>
...
<?php 
    if(isset($_POST['saveprofile']))
    {
        ...
        {
            $check_name = $row_add_check['bus_operator_name'];
        ...
        <script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '/FYP/admin/bus operator/add bus operator process.php',
                        type: 'POST',
                        data: {
