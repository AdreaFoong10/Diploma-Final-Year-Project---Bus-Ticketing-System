...
<script>
    Swal.fire({
        title: 'Do you want to delete <?php echo $title ?> ID : <?php echo $Id_delete ?> ?',
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            Swal.fire({
                    ...
                    $.ajax({
                        url: '/FYP/admin/booking details/delete booking detail process.php',
                        type: 'POST',
                        data: {
                        ...
                        success: function(response) {
                            Swal.fire({
                                ...
                                timer: 3000,
                                willClose: () => {
                                    window.location.href = 'booking detail.php';
                                }
                            });
                        },
