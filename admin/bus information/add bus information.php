                                                    ...
                                                    <div class="customer">
                                                        ...
                                                        <form method="POST">
                                                            ...
                                                            <div style="margin-top: 5rem; flex-direction: row; display: flex; align-items: normal;">
                                                                <label for="bus_info_license"><h4 style="font-size: 1.5em">Bus License Plate : </h4> </label>
                                                                <input type="text" style="flex-direction: row; margin-left: 3.2rem;" id="bus_info_license" placeholder="License Plate" name="bus_info_license" size="35" required>
                                                            </div>
                                                            ...
                                                            <div style="margin-top: 5rem; flex-direction: row; display: flex; align-items: normal;">
                                                                ...
                                                                <select id="bus_info_route" style="flex-direction: row; margin-left: 1.15rem;" placehoder="Route" name="bus_info_route" required>
                                                                    ...
                                                                    <?php
                                                                        $_SESSION['route_id_get'] = $row_route_id_sql['route_id'];
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div id="bus_schedule_div" style="display: none; margin-top: 5rem; flex-direction: row; display: flex; align-items: normal;">
...
<?php 
    if(isset($_POST['saveprofile']))
    {
        ...
        {
            $check_num_plate = $row_add_check['bus_number_plate'];
            

            if($bus_info_license === $check_num_plate)
            {
                ?>
                <script>
                     Swal.fire({
        ...
        <script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '/FYP/admin/bus information/add bus information process.php',
                        type: 'POST',
                        data: {
